...
class Category(models.Model):
    ...
    """
    amazon_node_id = models.IntegerField(null=True, help_text="A positive integer assigned by Amazon that uniquely identifies a product category.<br>For help refer to <a target='_blank' href='https://affiliate-program.amazon.com/gp/associates/help/t41/a6'>this page</a>.")
    ...
    def __unicode__(self):
        return str(self.amazon_node_id)
