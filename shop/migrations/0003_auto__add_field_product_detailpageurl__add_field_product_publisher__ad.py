...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.detailpageurl'
        db.add_column('shop_product', 'detailpageurl',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.publisher'
        db.add_column('shop_product', 'publisher',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Product.brand'
        db.add_column('shop_product', 'brand',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.detailpageurl'
        db.delete_column('shop_product', 'detailpageurl')

        # Deleting field 'Product.publisher'
        db.delete_column('shop_product', 'publisher')

        # Deleting field 'Product.brand'
        db.delete_column('shop_product', 'brand')
